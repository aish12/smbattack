...
def performAttack(location, servername, username, password=None):
	if (password is None):
...
parser.add_argument('--servername', type=str, help="Enter the name of the targer windows server")
...
if args.password:
	performAttack(args.mountloc, args.servername, args.username, args.password)
else:
	performAttack(args.mountloc, args.servername, args.username)
